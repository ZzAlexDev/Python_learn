...
class Scores():
    ...
    def __init__(self, screen, stats):
        """Initialization Score Game"""
        self.screen = screen
        self.screen_rect = screen.get_rect()
        self.stats = stats
        self.text_color = (140, 195, 80)
    ...
    def image_score(self):
        """Convert text of score to image"""
    ...
    def image_guns(self):
        ...
        for gun_number in range(self.stats.guns_left):
            gun = Gun(self.screen)
            gun.rect.x = 15 + gun_number*(gun.rect.width+10)
            gun.rect.y = 20
            self.guns.add(gun)

    def image_high_score(self):
        """"Convert High Score ti Image"""
